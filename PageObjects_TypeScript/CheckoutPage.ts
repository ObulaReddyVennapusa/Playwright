...
export class CheckoutPage {
  ...
  couponTextOnSuccess:Locator;
  CountryInput:Locator;
  dropdownWaiting:Locator;
  dropdown:Locator;
  placeOrder:Locator;
  ...
  async personelInformation(cvv: string, nameOnCard: string, coupoun: string) {
...
async selectCountry(searchText: string, selectCountry: string){
...
let country: any;
    country= await dropDown.nth(i).textContent();
